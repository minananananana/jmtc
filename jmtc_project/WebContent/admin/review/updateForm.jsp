<%@ page language="java" contentType="text/html; charset=UTF-8"
  ...
  <div class="wrapper left_table">
  	<form name="updateForm" method="post" action="${ctxpath}/admin/review/updatePro.do2?member_idx=${sessionScope.idx}&pageNum=${pageNum}">
	    <table>
	      ...
	      <tr>
	        <td colspan="2" align="center">
	          ...
	          <input type="button" value="리스트" onClick="location='${ctxpath}/admin/review/list.do2?member_idx=${sessionScope.idx}&pageNum=${pageNum}'" class="default_btn mt40">
	        </td>
	      </tr>
