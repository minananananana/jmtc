			...
			<tr>
				<td colspan="2" align="center">
					<c:if test="${qna_idx==0 }">
	 				...
	 				<c:if test="${qna_idx!=0 && sessionScope.id == 'admin'}">
						<input type="submit" value="답글쓰기" class="pointer_btn mt40">
	 				</c:if>
				
					<input type="button" value="리스트" onclick="location.href='${ctxpath }/qna/list.do?member_idx=${sessionScope.idx}'" class="default_btn mt40">
				</td>
