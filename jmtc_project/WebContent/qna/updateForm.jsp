...
<div class="wrapper left_table">
  <form name="updateForm" method="post" action="${ctxpath}/qna/updatePro.do?member_idx=${sessionScope.idx}&pageNum=${pageNum}">
  	<table class="wid">
  		<tr>
  			<td>이름</td>
  			<td class="bd_bt">
  		...
  		<tr>
  			<td colspan="2" align="center">
	  			...
	  			<input type="button" value="리스트" onClick="location='${ctxpath}/qna/list.do?member_idx=${sessionScope.idx}&pageNum=${pageNum}'" class="default_btn mt40">
  			</td>
  		</tr>
  	</table>
  </form>
