...
//컨트롤러 (서블릿, 자바 문법)
public class ControllerDispatcher2 extends HttpServlet {
	...
	private void reqPro(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
		...
		request.setAttribute("CONTENT2", view);
		
		RequestDispatcher rd = request.getRequestDispatcher("/admin/template/template.jsp");
